...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-[80vh] flex items-center justify-center  text-black overflow-hidden" style={{
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/courses"
            className="px-6 py-3 bg-white text-blue-700 font-semibold rounded-full hover:bg-gray-200 transition"
          >
            Explore Courses
          </Link>
          ...
          <Link
            href="/register"
            className="px-6 py-3 border border-white text-white rounded-full font-semibold hover:bg-white hover:text-blue-700 transition"
          >
            Get Started
          </Link>
        </div>
